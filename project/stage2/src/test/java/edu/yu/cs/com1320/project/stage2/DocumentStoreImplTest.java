...
public class DocumentStoreImplTest {
    ...
    @Test
    public void undoPutStam() throws IOException{
        //first adding a document
        DocumentStore store = new DocumentStoreImpl();
        Document doc1 = new DocumentImpl(this.uri1, this.txt1);
        Document doc2 = new DocumentImpl(this.uri2, this.txt2);
    ...
    @Test
    public void undoDeleteStam() throws IOException{
        DocumentStore store = new DocumentStoreImpl();
        Document doc1 = new DocumentImpl(this.uri1, this.txt1);
        store.putDocument(new ByteArrayInputStream(this.txt1.getBytes()),this.uri1, DocumentStore.DocumentFormat.TXT);
        assertEquals(doc1, store.getDocument(uri1));
    ...
    @Test 
    public void undoReplaceStam() throws IOException{
        DocumentStore store = new DocumentStoreImpl();
        Document doc1 = new DocumentImpl(this.uri1, this.txt1);
        Document doc2 = new DocumentImpl(this.uri1, this.txt2);
        assertEquals(null, store.getDocument(uri1));
        store.putDocument(new ByteArrayInputStream(this.txt1.getBytes()),this.uri1, DocumentStore.DocumentFormat.TXT);
        assertEquals(doc1, store.getDocument(uri1));
    ...
    @Test
    public void dealWithDeletingNothing() throws IOException{
        DocumentStore store = new DocumentStoreImpl();
        assertEquals(null, store.getDocument(uri1));
        try{
            store.undo();
        }catch(IllegalStateException e){}
        store.putDocument(null,this.uri1, DocumentStore.DocumentFormat.TXT);
        assertEquals(null, store.getDocument(uri1));
        store.undo();
        assertEquals(null, store.getDocument(uri1));
        try{
    ...
    @Test
    public void TestundoURI() throws IOException{
        DocumentStore store = new DocumentStoreImpl();
        Document doc1 = new DocumentImpl(this.uri1, this.txt1);
        Document doc2 = new DocumentImpl(this.uri2, this.txt2);
        Document doc3 = new DocumentImpl(this.uri3, this.txt3);
        assertEquals(null, store.getDocument(uri1));
        assertEquals(null, store.getDocument(uri2));
    ...
    //need to test for multiple commands of the same uri
    //test above long test with replace/delete
    @Test 
    public void testMultipleCommands() throws IOException{
        DocumentStore store = new DocumentStoreImpl();
        Document doc1 = new DocumentImpl(this.uri1, this.txt1);
        Document doc2 = new DocumentImpl(this.uri1, this.txt2);
        Document doc3 = new DocumentImpl(this.uri1, this.txt3);
        ...
        assertEquals(doc3, store.getDocument(uri1)); 
        store.putDocument(null,this.uri1, DocumentStore.DocumentFormat.TXT);
        assertEquals(null, store.getDocument(uri1)); 
