...
public class HashTableImplTest {
    ...
    public void Testmill(){
       ...
       assertEquals(50001, table.get(50000));
    }

    @Test
    public void testDeleteViaPutNull2() {
        HashTableImpl<String, String> table = new HashTableImpl<String, String>();
        assertEquals(null, table.get("key1"));
        assertEquals(null, table.get("key6"));
        assertEquals(null, table.get("key11"));
        assertEquals(null, table.put("key1", "V1"));
        assertEquals(null, table.put("key6", "V2"));
        assertEquals(null, table.put("key11", "V3"));
        assertEquals("V1", table.put("key1", null));
        assertEquals("V2", table.get("key6"));
        assertEquals("V2", table.put("key6", null));
        assertEquals("V3", table.get("key11"));
        assertEquals("V3", table.put("key11", null));
    }
